INSERT INTO users (id, username, first_name) 
    VALUES (1779942116, 'duffman152', 'duffman152');

INSERT INTO gas_nn_accounts (user, name, login, family_name, auto_sending) 
    VALUES (1779942116, 'Счетчик в квартире', '051000322434', 'Кривенков', 0);

INSERT INTO gas_nn_accounts (user, name, login, family_name, auto_sending)
    VALUES (1779942116, 'Счетчик в доме', '051000507028', 'Степанов', 1);
